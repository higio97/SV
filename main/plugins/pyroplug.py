...
async def check(userbot, client, link):
    ...
    if 't.me/c/' in link:
        try:
            ...
            return False, "Sudahkah Anda bergabung dengan saluran?"
    else:
        try:
            ...
            return False, "Mungkin bot diblokir dari obrolan, atau tautan Anda tidak valid!"
...
async def get_msg(userbot, client, sender, edit_id, msg_link, i):
    ...
    if 't.me/c/' in msg_link:
        ...
        try:
            ...
            await client.edit_message_text(sender, edit_id, "Sudahkah Anda bergabung dengan saluran?")
            return 
