...
async def force_sub(client, channel, id, ft):
    ...
    try:
        ...
        left = x.stringify()
        if 'left' in left:
            s, r = True, f"{ft}\n\nDan juga bergabung @Anonim235"
        else:
            s, r = False, None
    except UserNotParticipantError:
        s, r = True, f"Untuk menggunakan bot ini Anda harus bergabung @{channel}.\n\nDan juga bergabung @Anonim235" 
    except Exception:
        s, r = True, "KESALAHAN: Tambahkan di saluran ForceSub, atau periksa id saluran Anda."
    return s, r
